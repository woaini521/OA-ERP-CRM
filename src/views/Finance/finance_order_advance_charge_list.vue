    ...
    <div class="box">
        ...
        <div class="content_box">
            <el-table :data="tabledata">
                ...
                <el-table-column label="收款账户" prop="receiving_account"></el-table-column>
    ...
    methods:{
        ...
        seachName(){
            this.axios.post('/Finance/finance_order_advance_charge_list',{
                ...
                this.tabledata = res.data.advance_charge.data;
                this.currentPage = res.data.advance_charge.current_page;
                this.total = res.data.advance_charge.total;
                this.per_page = res.data.advance_charge.per_page;
                this.last_page = res.data.advance_charge.last_page;
            })
        },
        // 获取列表数据
        gettabledata(){
            this.axios.get('/Finance/finance_order_advance_charge_list').then(res => {
                this.tabledata = res.data.advance_charge.data;
                this.currentPage = res.data.advance_charge.current_page;
                this.total = res.data.advance_charge.total;
                this.per_page = res.data.advance_charge.per_page;
        ...
        getimgUrl(a){
            this.axios.get('/crm.Order/customer_order_file_select?id='+a+'&data_table=customer_order_advance_charge').then(res => {
                if(res.data.customer_order_advance_charge != null){
