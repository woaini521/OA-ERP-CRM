            ...
            <div class="contract">
                ...
                <div class="contractInner">
                    ...
                    <el-upload
                        ...
                        action="/file/product_stockup_supplier_file"
...
export default {
    ...
    methods:{
        // 搜索查询
        seachName(){
            this.axios.post('/Finance/finance_product_stockup_supplier_lists',{
        ...
        // 获取列表数据
        gettabledata(){
            this.axios.get('/Finance/finance_product_stockup_supplier_lists').then(res => {
                this.tabledata = res.data.data;
                this.currentPage = res.data.current_page;
                this.total = res.data.total;
                this.per_page = res.data.per_page;
        ...
        getimgUrl(a){
            this.axios.post('/file/file_select',{
               ...
               id:a,
               data_table:'product_stockup_supplier',
            }).then(res => {
                if(res.data != null){
