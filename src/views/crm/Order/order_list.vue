...
<template>
  <div class="box">
    <div class="box_head">
      <el-select v-model="value2" placeholder="公司查询" filterable clearable style="margin-left: 10px;width:217px;">
        <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id"></el-option>
      </el-select>

      <el-input v-model="value"  placeholder="客户名称"  @keyup.enter.native="seach" style="margin-left: 20px;width:217px;"></el-input>
...
export default {
  ...
  methods: {
    ...
    getOrderList() {
      ...
      this.axios.get("/crm.Order/order_list").then(res => {
